  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        action={
          <>
            <ButtonLink to="/app/qr" variant="secondary" size="sm">
              <QrCode size={15} /> QR studio
            </ButtonLink>
            <ButtonLink to="/app/insights" size="sm">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardHeader
            ...
            action={
              <Link to="/app/products" className="text-[13px] font-medium text-accent hover:underline">
                All products
              </Link>
            }
          />
      ...
      <Card>
        <CardHeader
          ...
          action={
            <Link to="/app/reviews" className="text-[13px] font-medium text-accent hover:underline">
              All reviews
            </Link>
          }
        />
