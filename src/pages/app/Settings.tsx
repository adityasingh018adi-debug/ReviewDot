...
import { Field, Input, Label, Select, Toggle } from '@/components/ui/Field'
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader
            ...
            subtitle="Optional. Without a key, AI insights run on the built-in analyst."
            action={<Badge tone={apiKey ? 'positive' : 'neutral'}>{apiKey ? 'Connected' : 'Not connected'}</Badge>}
          />
          ...
          <p className="mt-2 text-[12px] leading-relaxed text-faint">
            The key is stored in this browser only and is sent directly to Anthropic from your device. Remove it any
            time by clearing the field and saving.
          </p>
          <div className="mt-4 flex gap-2">
            ...
            >
              {saved ? <Check size={15} /> : null} {saved ? 'Saved' : 'Save key'}
            </Button>
            {apiKey ? (
              <Button
                variant="secondary"
          ...
          <div className="mt-8 border-t border-line pt-6">
            ...
            <p className="mt-1 text-[13px] leading-relaxed text-muted">
              Reset the QR codes you created, the feedback you submitted through the scan experience, and any status
              changes. The seeded demo history stays.
            </p>
