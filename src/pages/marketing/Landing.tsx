    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-page relative grid gap-12 py-14 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:py-20">
          ...
          >
            <Eyebrow>Customer Experience &amp; Review Intelligence</Eyebrow>
            ...
            <p className="mt-5 max-w-xl text-[16px] leading-relaxed text-muted sm:text-[17px]">
              Collect customer feedback, understand your products, and grow your online reputation — all from one
              simple QR code.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <ButtonLink to="/product" size="lg" variant="secondary">
                See How It Works
              </ButtonLink>
            </div>
      ...
      <section className="py-20">
        <div className="container-page">
          <SectionHeading
            ...
            title="Ten seconds on a phone. Nothing to download."
            description="Fast, honest and transparent. Happy customers are invited to share publicly; unhappy ones reach your team directly — never blocked, never manipulated."
          />
          ...
          <Reveal className="mx-auto mt-10 max-w-2xl text-center">
            ...
            <ButtonLink to={`/r/${demoQR.code}`} variant="secondary" className="mt-4">
          ...
          <div className="grid-backdrop relative overflow-hidden rounded-[32px] border border-line bg-surface px-6 py-16 text-center shadow-card sm:px-16">
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-[12px] text-faint">
                ...
                <Link to="/product" className="font-medium text-accent hover:underline">
